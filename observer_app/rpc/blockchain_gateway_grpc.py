...
class BlockchainGatewayServiceBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def Health(self, stream: 'grpclib.server.Stream[blockchain_gateway_pb2.EmptyRequest, blockchain_gateway_pb2.EmptyRequest]') -> None:
        pass

    @abc.abstractmethod
    async def GetAvailableCurrencies(self, stream: 'grpclib.server.Stream[blockchain_gateway_pb2.EmptyRequest, blockchain_gateway_pb2.AvailableCurrenciesResponse]') -> None:
        pass

    @abc.abstractmethod
    async def GetBalance(self, stream: 'grpclib.server.Stream[blockchain_gateway_pb2.GetBalanceRequest, blockchain_gateway_pb2.GetBalanceResponse]') -> None:
        pass

    @abc.abstractmethod
    async def GetWallet(self, stream: 'grpclib.server.Stream[blockchain_gateway_pb2.GetWalletRequest, blockchain_gateway_pb2.GetWalletResponse]') -> None:
        pass

    @abc.abstractmethod
    async def SendTransaction(self, stream: 'grpclib.server.Stream[blockchain_gateway_pb2.SendTransactionMessage, blockchain_gateway_pb2.SendTransactionMessage]') -> None:
        pass

    @abc.abstractmethod
    async def GetTransactionsList(self, stream: 'grpclib.server.Stream[blockchain_gateway_pb2.GetTransactionsListRequest, blockchain_gateway_pb2.GetTransactionsListResponse]') -> None:
        pass

    @abc.abstractmethod
    async def GetTransaction(self, stream: 'grpclib.server.Stream[blockchain_gateway_pb2.GetTransactionRequest, blockchain_gateway_pb2.GetTransactionResponse]') -> None:
        pass

    @abc.abstractmethod
    async def SendFromColdWallet(self, stream: 'grpclib.server.Stream[blockchain_gateway_pb2.SendFromColdWalletRequest, blockchain_gateway_pb2.SendFromColdWalletResponse]') -> None:
        pass

    @abc.abstractmethod
    async def SendToColdWallet(self, stream: 'grpclib.server.Stream[blockchain_gateway_pb2.SendToColdWalletRequest, blockchain_gateway_pb2.SendToColdWalletResponse]') -> None:
        pass

    @abc.abstractmethod
    async def CheckAddress(self, stream: 'grpclib.server.Stream[blockchain_gateway_pb2.CheckAddressRequest, blockchain_gateway_pb2.CheckAddressResponse]') -> None:
        pass
